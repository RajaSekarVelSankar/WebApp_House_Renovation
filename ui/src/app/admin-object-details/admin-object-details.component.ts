...
export class AdminObjectDetailsComponent implements OnInit {
  ...
  constructor(private objecttsService:ObjectsService ,private router: Router) { }
  ...
  ngOnInit(): void {
    ...
    if (this.context) { 
      ...
      this.objecttsService.getById(this.objecttId).subscribe((data : Object)=>{
  ...
  objecttId : number;
  selectedObjectt : Object = new Object();
